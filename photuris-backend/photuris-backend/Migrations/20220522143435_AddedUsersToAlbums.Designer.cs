...
namespace photuris_backend.Migrations
{
    ...
    [Migration("20220522143435_AddedUsersToAlbums")]
    partial class AddedUsersToAlbums
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("photuris_backend.DbContext.Entities.Album", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlbumPicture", b =>
                {
                    b.HasOne("photuris_backend.DbContext.Entities.Album", null)
                        .WithMany()
                        .HasForeignKey("AlbumsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("photuris_backend.DbContext.Entities.Picture", null)
                        .WithMany()
            ...
            modelBuilder.Entity("photuris_backend.DbContext.Entities.Album", b =>
                {
                    b.HasOne("photuris_backend.DbContext.Entities.User", "User")
                        .WithMany()
